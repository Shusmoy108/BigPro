            ...
            for (var i = 0; i < this.state.subtasklist.length; i++) {
                subtasklist.push(
                    <Subtask
                        ...
                        subtask_option={
                            this.state.subtasklist[i].subtask_option
                        }
        ...
        if (this.state.spec !== -1) {
            subtask = (
                <Showspec
                    back={this.showspec}
                    subtaskname={
                        this.state.subtasklist[this.state.spec].subtask_name
                    }
                    subtasktype={
                        this.state.subtasklist[this.state.spec].subtask_type
                    }
                    option={
                        this.state.subtasklist[this.state.spec].subtask_option
                    }
                />
            );
        }
