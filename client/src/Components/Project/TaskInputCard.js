      ...
      if (subtask.subtask_type === "Textfield") {
        subtasks.push(
          <div>
            ...
            <TextField
              value={subtask.subtask_value}
              onChange={this.props.handleSpecChange(this.props.i, j)}
              margin="normal"
              variant="outlined"
            />
        ...
        subtasks.push(
          <div>
            ...
            <Select
              value={this.props.taskinput.subtask[j].subtask_value}
              onChange={this.props.handleSpecChange(this.props.i, j)}
        ...
        subtask.subtask_option.map((f, k) => {
          value.push(
            <div style={{ display: "inline-flex" }}>
              <Checkbox
                checked={this.props.taskinput.subtask[j].subtask_check[k]}
                onChange={() =>
                  this.props.handleCheckChange(this.props.i, j, k, f)
                }
                color="primary"
              />
              <div
